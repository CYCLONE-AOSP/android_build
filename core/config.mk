...
ifneq ($(CYCLONE_BUILD),)
include vendor/cyclone/config/BoardConfigCyclone.mk
endif
...
ifneq ($(CYCLONE_BUILD),)
ifneq ($(wildcard device/cyclone/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/cyclone/sepolicy/common/sepolicy.mk)
endif
endif
